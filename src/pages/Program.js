  ...
  return (
    <div >
      ...
      <DeviceCard>
        ...
        <DeviceDescription>
          줄기세포를 손상없이 고출력 저진동으로 진피층까지 전달하는 두피발모 전문 혁신 디바이스
        </DeviceDescription>
        ...
        <FeatureCardsContainer>
          <FeatureCard>
            ...
            <FeatureDescription>
              두피의 진피층을 부드럽고 효과적인 방식으로 활성화하는 하이진 니들로 구성됩니다.
            </FeatureDescription>
          </FeatureCard>
          ...
          <FeatureCard>
            ...
            <FeatureDescription>
              60초당 15,000번의 고출력 저진동으로 두피에 자극없이 모낭 주변까지 줄기세포를 도달시킵니다.
            </FeatureDescription>
          </FeatureCard>
          ...
          <FeatureCard>
            ...
            <FeatureDescription>
              기존 MTS 방식의 틀을 깬 하이진 니들을 적용해 상처 및 통증없이 발모효과를 극대화합니다.
            </FeatureDescription>
          </FeatureCard>
        </FeatureCardsContainer>
      </DeviceCard>
      ...
      <MorissetProductCard>
        ...
        <DeviceDescription>
          ISO 인증을 받은 유럽 제약회사 제조 과정에 기반한 효과적인 탈모 완화 핵심 성분
        </DeviceDescription>
        ...
        <FeatureCardsContainer>
          <FeatureCard>
            ...
            <FeatureDescription>
              두피세포 재생을 위한 식물성 줄기세포의 안전성과 유효성을 자랑하며, 근본적인 자가 치유력을 향상시킵니다.
            </FeatureDescription>
          </FeatureCard>
          ...
          <FeatureCard>
            ...
            <FeatureDescription>
              쏘팔메토 줄기세포 활성성분이 혈액 및 림프의 순환을 자극해 제품의 침투 효율을 최대 97%까지 증가시킵니다.
            </FeatureDescription>
          </FeatureCard>
          ...
          <FeatureCard>
            ...
            <FeatureDescription>
              탈모를 유발하는 DHT 호르몬을 표적침투 및 억제시키는 특화된 성장인자로 요요현상없는 두피를 만들어줍니다.
            </FeatureDescription>
          </FeatureCard>
         </FeatureCardsContainer>
       </MorissetProductCard>
        ...
        <ResearchSection>
          ...
          <ResearchCardsContainer>
            <ResearchCard>
              ...
              <ResearchContent>
                쏘팔메토를 섭취한 남성 탈모인 참가자 중 <strong>60% 모발 빠짐 감소</strong>
              </ResearchContent>
            </ResearchCard>
            ...
            <ResearchCard>
              ...
              <ResearchContent>
                쏘팔메토가 함유된 샴푸와 로션을 3개월간 사용했을 때 <strong>모발 밀도 35% 증가 및 피지 67% 감소</strong>
              </ResearchContent>
            </ResearchCard>
            ...
            <ResearchCard>
              <ResearchYear>2004년 연구 中</ResearchYear>
              <ResearchContent>
                16주간 쏘팔메토 섭취 및 국소치료한 결과, <strong>모발 탈락 29% 감소, 모발 굵기 7.61% 증가. 부작용 발견되지 않음</strong>
              </ResearchContent>
            </ResearchCard>
            ...
            <ResearchCard>
              ...
              <ResearchContent>
                쏘팔메토의 경우 전립선 특이항원 (PSA) 수치에 영향을 미치지 않음. 그에 반해 <strong>피나스테리드의 경우 PSA 수치 크게 증가</strong>
              </ResearchContent>
            </ResearchCard>
            ...
            <ResearchCard>
              ...
              <ResearchContent>
                쏘팔메토 섭취 및 국소치료한 결과, 참가자 중 <strong>60%가 모질의 개선을, 27%가 모발 개수의 증가, 83%가 모발 밀도의 개선을 경험</strong>
              </ResearchContent>
            </ResearchCard>
            ...
            <ResearchCard>
              ...
              <ResearchContent>
                12주간 1일2회 쏘팔메토를 주 성분으로 하는 두피세럼 도포 후 <strong>두피 수분량 67% 증가, 미세순환 4% 증가, 모발 성장기 47% 증가 및 퇴행기 40% 감소</strong>
              </ResearchContent>
            </ResearchCard>
          </ResearchCardsContainer>
        </ResearchSection>
        ...
        <MesoProductSection>
          ...
          <EfficacyGrid>
            ...
            <EfficacyItem>
              <Checkmark>·</Checkmark>
              <EfficacyText>출산, 스트레스 또는 수면 장애 후 모낭 재활성화</EfficacyText>
            </EfficacyItem>
          </EfficacyGrid>
        </MesoProductSection>
        ...
        <MesoProductSection>
          ...
          <TricocureSubtitle>: Stronger, healthier, more structured hair</TricocureSubtitle>
          
          <TricocureProductImage src={product_6} alt="TRICOCURE HAIR LOSS SHAMPOO" />
          ...
          <AntiDHTGrid>
            <AntiDHTItem>
              <AntiDHTCheckmark>·</AntiDHTCheckmark>
              <AntiDHTText>모발 강화를 위해 설계된 새로운 특허 솔루션</AntiDHTText>
            </AntiDHTItem>
            
            <AntiDHTItem>
              <AntiDHTCheckmark>·</AntiDHTCheckmark>
              <AntiDHTText>손상된 케라틴을 강화시키고 구조를 재구성하여 모발 관리성 회복</AntiDHTText>
            </AntiDHTItem>
            
            <AntiDHTItem>
              <AntiDHTCheckmark>·</AntiDHTCheckmark>
              <AntiDHTText>정기적인 사용을 통한 강하고, 건강하고 구조화된 모발</AntiDHTText>
            </AntiDHTItem>
          </AntiDHTGrid>
        </MesoProductSection>
        
        <MesoProductSection>
          <TricocureTitle>오픈 6개월 만에 단 하나의 프로그램으로 월매출 3500만원 달성 이유:</TricocureTitle>
          <TricocureSubtitle>모발 성장 주기에 맞춘 최고의 근본적 솔루션</TricocureSubtitle>
